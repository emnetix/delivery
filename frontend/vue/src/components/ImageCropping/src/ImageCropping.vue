    ...
    <div>
      ...
      <div v-if="showActions" class="mt-10px flex items-center">
        <div class="flex items-center">
          <ElTooltip content="파일 선택" placement="bottom">
            <ElUpload
              action="''"
              accept="image/*"
              :auto-upload="false"
